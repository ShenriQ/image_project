 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
     ...
     <div class="sidebar">
         ...
         <div class="text-center mt-3">
            ...
            ?>
                 <img src="<?php echo img_url( $images[0]->img_path ); ?>" class="img-circle elevation-2"
                     alt="User Image">
             </div>
             <div class="info" style="margin-top: 2px;">
                 <a href="<?php echo site_url("admin/shops/edit/" . $shop_id); ?>">
                     ...
                     <span style="font-size: 18px;color: #fff; font-style: bold;">
                         <?php echo $this->Shop->get_one('shop0b69bc5dbd68bbd57ea13dfc5488e20a')->name . " "; ?></span>
                 </a>
             </div>
             <hr />
         </div>
         ...
         <nav class="mt-2">
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                foreach ( $module_groups as $group ): 
                  if ($group->group_name != 'Entry' && $group->group_name != 'Reports') :
            ...
            ?>
                ...
                ?>
                    ...
                    $module->group_id == $group->group_id ): ?>
                         <li class="nav-item">
                             <a href="<?php echo site_url($be_url) . '/'. strtolower( $module->module_name ); ?>"
                                 class="nav-link <?php echo $active_state; ?>">
